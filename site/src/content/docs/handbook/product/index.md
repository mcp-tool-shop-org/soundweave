---
title: What Soundweave Is
description: Product definition and composition-first design philosophy
sidebar:
  order: 0
---
...
Soundweave is an adaptive soundtrack studio. It is a workstation for composing, arranging, scoring, mixing, automating, performing, and exporting interactive music for games.
...
## Why Soundweave Exists

Game music has been either pre-rendered and static, or dynamically stitched together from tiny fragments with no compositional ambition. Soundweave exists to close that gap.

Adaptive music for games needs its own workstation because:

- **DAWs don't model game state.** A DAW renders a flat timeline. Games have branching state machines, intensity curves, regional identities, and non-linear progression. Soundweave models all of that.
- **Middleware is logistics, not composition.** Existing game audio middleware focuses on playback routing and asset management. Soundweave starts from the music itself — composition, arrangement, and performance — and makes adaptation flow from that.
...
## Soundweave as Instrument, Not Toy
...
## Composition-First, Adaptation-Aware

Soundweave's design philosophy starts with music. The product is built so that:
