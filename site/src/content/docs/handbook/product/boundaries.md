...
Soundweave is not a spreadsheet for organizing music files. It actively composes, arranges, and structures music. Clips have notes. Cues have timelines. Scenes have layers. Automation lanes have curves. The data model is dense because the product does real musical work.

## Not a Toy Sequencer

The clip editor, cue structure, scale/chord tools, motif transforms, intensity derivation, and automation system exist to produce professional-quality results. Soundweave is not a grid of colored blocks that beep. It is a composition workstation with a deep musical vocabulary.
